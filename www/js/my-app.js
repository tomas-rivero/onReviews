...
$$(document).on("page:init", '.page[data-name="index"]', function (e) {
  ...
  function onSuccess(position) {
    ...
    sessionStorage.setItem("latitud", latitude);
...
function maps(){
  contador= contador + 1;
  if (contador == 1){
    console.log("cargaron los mapas");
    //HERE MAPS
    var platform = new H.service.Platform({
      apikey: "E3Ul8816_XI0GerJ8WjDw825Tc5QiCFkqaFllOphLn8",
    });
    ...
    var icon = new H.map.Icon("./assets/icons/cinemaMark.png");
    ...
    function addInfoBubble(map) {
      var cinema = new H.map.Group();
  
      map.addObject(cinema);
  
      addMarkerToGroup(cinema, {
        lat: -32.92799102232746,
        lng: -60.667837146110024,
      });
      addMarkerToGroup(cinema, {
        lat: -32.909961047524604,
        lng: -60.683267497394134,
      });
      addMarkerToGroup(cinema, {
        lat: -32.93382732303895,
        lng: -60.70108004790484,
      });
      addMarkerToGroup(cinema, {
        lat: -32.94696097715158,
        lng: -60.636890091819524,
      });
    }
